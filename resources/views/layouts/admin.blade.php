...
{{--            <img src="/sst.jpg" alt="SSTraders" width="200">--}}
        ...
        <ul class="list-unstyled components">
            ...
            <li class="accordion" id="accordionExample">
                ...
                <ul class="{{ Request::path() === 'file_edit' || Request::path() === 'file_list' || Request::path() === 'file_datas' || Request::path() === 'file_datas/create' ? 'show ' : ''}}collapse list-unstyled" data-parent="#accordionExample" id="dataSubmenu">
                    @role('admin|receiver')
                        <li>
                ...
                <ul class="{{ Request::path() === 'deliver_report' || Request::path() === 'operator_report'|| Request::path() === 'receiver_report'}}collapse list-unstyled" data-parent="#accordionExample" id="reportSubmenu">
                    <li>
